            ...
            <div class="duplicate-modal-content">
                ...
                <div class="duplicate-comparison">
                    <div class="existing-data">
                        ...
                        <p><strong>MBTI类型:</strong> ${existingData.mbtiType || '无'}</p>
                    ...
                    <div class="new-data">
                        ...
                        <p><strong>MBTI类型:</strong> ${newData.mbtiType || '无'}</p>
                    </div>
                </div>
                ...
                <div class="duplicate-note">
                    <p><small>💡 选择"更新现有记录"将覆盖之前的MBTI信息，选择"取消提交"可以修改当前表单内容。</small></p>
                </div>
            </div>
        `;
    ...
    showFirebaseSuccessMessage(studentData, firebaseId, isUpdate = false, updateCount = 0) {
        ...
        const message = `
            <div class="success-content">
                <h3>🎉 ${isUpdate ? 'MBTI信息更新成功！' : 'MBTI Information Submitted Successfully!'}</h3>

    ...
    showDuplicateConfirmation(newData, existingData) {
        ...
        modal.innerHTML = `
            <div class="duplicate-modal-content">
                ...
                <p>The system found an existing student record with the same name and birth date</p>
                </div>
                ...
                <div class="duplicate-comparison">
                    <div class="existing-data">
                        ...
                        <p><strong>Birthday:</strong> ${this.getMonthName(existingData.birthDate.month)} ${existingData.birthDate.day}</p>
                        <p><strong>Interests:</strong> ${existingData.interests ? existingData.interests.join(', ') : 'None'}</p>
                    ...
                    <div class="new-data">
                        ...
                        <p><strong>Birthday:</strong> ${this.getMonthName(newData.birthDate.month)} ${newData.birthDate.day}</p>
                        <p><strong>Interests:</strong> ${newData.interests ? newData.interests.join(', ') : 'None'}</p>
                    </div>
                </div>
                ...
                <div class="duplicate-note">
                    <p><small>💡 Choose "Update Existing Record" to overwrite previous information, or "Cancel Submission" to modify the current form content.</small></p>
                </div>
            </div>
        `;
    ...
    showFirebaseSuccessMessage(studentData, firebaseId, isUpdate = false, updateCount = 0) {
        let message = `
            <div class="success-content">
                <h3>🎉 ${isUpdate ? 'Update Successful!' : 'Submission Successful!'}</h3>
